...
class MultiModalAttrDataset(data.Dataset):
    ...
    def __init__(self, split, args, transform=None, target_transform=None):
        ...
        assert args.dataset in ['PA100k',"DUKE","MARS", 'RAPV1','RAPV2','PETA','WIDER','RAPzs','PETAzs','UPAR','YCJC',"EventPAR"], \
        ...
        if args.dataset=='PETA':
            ...
            dataset_info = pickle.load(open("/wdata/Code/ZF/OpenPAR/EventPAR_Benchmark/VRWKV_PAR_Backbone/pretrain/pad_duke.pkl", 'rb+'))
        elif args.dataset=='MARS':
            dataset_info = pickle.load(open("/wangx_nas/Dataset/mars_annotation/mars_pad_right.pkl", 'rb+'))
        ...
        if args.dataset=='PA100k' or args.dataset=='RAPV1':
            ...
            self.attributes=dataset_info.attr_name
            self.root_path = "/wangx/DATA/Dataset/DUKE/pad_duke_dataset_event/"
        elif args.dataset=='MARS':
            self.attributes=dataset_info.attr_name
            self.root_path = "/wangx_nas/Dataset/pad_mars_dataset_event/"
    ...
    def __getitem__(self, index):
        ...
        for filename in random.choices(rgb_img_list,k=6):
